...
bool TrustZoneCFIEnabled;
static cl::opt<bool, true>
EnableTrustZoneCFI("enable-arm-trustzone-cfi",
                  cl::desc("Enable TrustZone CFI"),
                  cl::location(TrustZoneCFIEnabled),
                  cl::init(false), cl::Hidden);
                  
bool SecureCFIEnabled;
static cl::opt<bool, true>
EnableSecureCFI("enable-arm-secure-cfi",
                  cl::desc("Enable Secure State CFI"),
                  cl::location(SecureCFIEnabled),
                  cl::init(false), cl::Hidden);
namespace llvm {
...
// xcfi
  if (XCFIEnabled()) {
    addPass(createARMXCFIForwardCFI());
    addPass(createARMXCFIBackwardCFI());
    addPass(createARMXCFIException());
    addPass(createARMXCFISecureException());
  }
