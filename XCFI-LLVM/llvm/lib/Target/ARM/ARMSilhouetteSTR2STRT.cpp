...
ARMSilhouetteSTR2STRT::runOnMachineFunction(MachineFunction & MF) {
  ...
  if (MF.getFunction().getName() == "z_arm_fault" || MF.getFunction().getName() == "relocate_vector_table" || MF.getFunction().getName() == "main" || MF.getFunction().getName() == "sys_clock_isr" ||
      ...
      MF.getFunction().getName() == "z_cstart" || MF.getFunction().getName() == "z_arm_fault_init" || MF.getFunction().getName() == "gpio_cmsdk_port_2_config_func" || MF.getFunction().getName() == "z_mrsh_k_thread_join" ||
      MF.getFunction().getName() == "z_arm_cpu_idle_init" || MF.getFunction().getName() == "z_arm_mpu_init" || MF.getFunction().getName() == "z_arm_configure_static_mpu_regions" || MF.getFunction().getName() == "z_arm_int_exit" ||
      MF.getFunction().getName() == "arm_core_mpu_configure_static_mpu_regions" || MF.getFunction().getName() == "arm_core_mpu_mark_areas_for_dynamic_regions" || MF.getFunction().getName() == "z_tick_sleep" ||
      MF.getFunction().getName() == "z_dummy_thread_init" || MF.getFunction().getName() == "z_device_state_init" || MF.getFunction().getName() == "k_object_init" || MF.getFunction().getName() == "z_impl_k_thread_suspend" ||
      MF.getFunction().getName() == "z_sys_init_run_level" || MF.getFunction().getName() == "statics_init" || MF.getFunction().getName() == "do_device_init" || MF.getFunction().getName() == "z_impl_k_wakeup" ||
      MF.getFunction().getName() == "gpio_cmsdk_ahb_init" || MF.getFunction().getName() == "gpio_cmsdk_port_0_config_func" || MF.getFunction().getName() == "arch_data_copy" || MF.getFunction().getName() == "z_mrsh_k_wakeup" ||
      MF.getFunction().getName() == "arm_irq_priority_set" || MF.getFunction().getName() == "arm_irq_enable" || MF.getFunction().getName() == "init_mem_domain_module" || MF.getFunction().getName() == "z_thread_abort" ||
      MF.getFunction().getName() == "arm_irq_disable" || MF.getFunction().getName() == "gpio_cmsdk_port_1_config_func" || MF.getFunction().getName() == "arch_mem_domain_max_partitions_get" || MF.getFunction().getName() == "z_impl_k_thread_abort" ||
      ...
      MF.getFunction().getName() == "z_impl_k_object_access_grant" || MF.getFunction().getName() == "arch_tls_stack_setup" || MF.getFunction().getName() == "sys_clock_set_timeout" || MF.getFunction().getName() == "arm_core_mpu_configure_dynamic_mpu_regions" ||
      MF.getFunction().getName() == "uart_cmsdk_apb_poll_out" || MF.getFunction().getName() == "mith_main_loop" || MF.getFunction().getName() == "region_init" || MF.getFunction().getName() == "mpu_region_get_access_attr" || 
      MF.getFunction().getName() == "mpu_configure_region" || MF.getFunction().getName() == "region_allocate_and_init"){
