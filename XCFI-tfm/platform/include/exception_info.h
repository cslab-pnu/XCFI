...
struct exception_info_t {
    ...
    uint32_t CFSR_NS;           /* Non-secure Configurable Fault Status Register. */
    uint32_t HFSR_NS;           /* Non-secure Hard Fault Status Register. */
    uint32_t BFAR_NS;           /* Non-secure Bus Fault Address Register. */
    uint32_t BFARVALID_NS;      /* Whether Non-secure BFAR contains a valid address. */
    uint32_t MMFAR_NS;          /* Non-secure MemManage Fault Address Register. */
    uint32_t MMARVALID_NS;      /* Whether Non-secure MMFAR contains a valid address. */
#endif
#endif
};
