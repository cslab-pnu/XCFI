...
** 
*************************/
#include "coremark-pro/mith/al/th_cfg.h"
#include "coremark-pro/mith/th_file.h"
#include "coremark-pro/mith/th_math.h" /* for th_sin, th_cos and th_pow */
#include "coremark-pro/mith/th_lib.h"
#include "coremark-pro/mith/th_rand.h" /* initialize a random data vector */
#include "coremark-pro/mith/al/th_types.h"
