...
#include "coremark-pro/mith/th_lib.h" /* for th_log */
#include "coremark-pro/mith/al/th_al.h"
#include "coremark-pro/mith/al/al_smp.h"
...
#if    HOST_EXAMPLE_CODE
#include "coremark-pro/mith/al/fp_shape.h"
